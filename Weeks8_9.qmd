...
-   l**ibrary(rvest):** The main package for web scraping. It's used to read HTML web pages and extract information from them.
...
#### **Scrape all the chapters for one book**

This loop (despite its name, it scrapes *all* chapters for *all* books) executes the final scraping.
